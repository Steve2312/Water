...
export const Drop: React.FC<Props> = (props: Props) => {
    return (
        <svg className={props.className} xmlns="http://www.w3.org/2000/svg" version="1.1"
             id="Layer_1" x="0px" y="0px" viewBox="0 0 81.96 122.88">
            <g>
                <path className="st0"
